            ...
            <section>
                <div class = "footerContent col-md-4"><!--left content-->
                    <p class = "footerContent1">
                        <strong>BGC</strong><span class = "small footerSubtext"></span>
                        <strong>TRUST</strong><span class = "small footerSubtext"></span>
                        <strong>UNIVERSITY</strong><span class = "small footerSubtext"> </span>
                        <strong>BANGLADESH</strong><span class = "small footerSubtext"></span>
                    </p>
